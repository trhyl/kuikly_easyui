...
import com.hy.kuikly_easyui.base.BasePager
import com.hy.kuikly_easyui.base.bridgeModule
...
internal class RouterPage : BasePager() {
    ...
    companion object {
        ...
        const val TIP =
            "输入规则：router 或者 router&key=value (&后面为页面参数)"
        ...
        private const val AAR_MODE_TIP =
            "如：router 或者 router&key=value （&后面为页面参数）"
    }

}

internal class RouterNavigationBar :
    ComposeView<RouterNavigationBarAttr, ComposeEvent>() {
            ...
            View {
                ...
                vif({ !ctx.attr.backDisable }) {
                    Image {
                        ...
                        event {
                            click {
                                getPager().acquireModule<RouterModule>(
