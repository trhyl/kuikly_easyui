...
import com.hy.kuikly_easyui.adapter.KRColorParserAdapter
import com.hy.kuikly_easyui.adapter.KRFontAdapter
import com.hy.kuikly_easyui.adapter.KRImageAdapter
import com.hy.kuikly_easyui.adapter.KRLogAdapter
import com.hy.kuikly_easyui.adapter.KRRouterAdapter
import com.hy.kuikly_easyui.adapter.KRThreadAdapter
import com.hy.kuikly_easyui.adapter.KRUncaughtExceptionHandlerAdapter
import com.hy.kuikly_easyui.module.KRBridgeModule
import com.hy.kuikly_easyui.module.KRShareModule
...
class KuiklyRenderActivity : AppCompatActivity(),
    ...
    private fun argsToMap(): MutableMap<String, Any> {
        val jsonStr =
            intent.getStringExtra(KEY_PAGE_DATA) ?: return mutableMapOf()
